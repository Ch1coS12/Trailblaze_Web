...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Function to edit the current sheet from details view
    window.editCurrentSheet = function() {
        if (currentSheet && currentSheet.executionSheet) {
            showEditModal(currentSheet.executionSheet.id);
        } else {
            showMessage('No sheet selected for editing');
        }
    };
